...
export async function procurarTodosMedicos()
{
...
export async function procurarMedicosPorSuaEspecialidade(especialidade)
...
export async function procurarMedicosPorSeuNome(nome)
